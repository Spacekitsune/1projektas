jQuery( document ).ready( function() {
	...
	wp.customize(
		'web_designer_h1_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'web_designer_h2_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'web_designer_h3_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'web_designer_web_designer_h4_font_size',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'web_designer_web_designer_h4_line_height',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'web_designer_web_designer_h4_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'web_designer_web_designer_h5_font_color',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'web_designer_web_designer_h5_font_family',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'web_designer_h5_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
	...
	wp.customize(
		'web_designer_h6_letter_spacing',
		function( value ) {
			value.bind( 
				function( to ) {
